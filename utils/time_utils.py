...
class DeformHead(nn.Module):
    def __init__(self, D=8, W=256, input_ch=96,is_blender=False, is_6dof=False):
        ...
        # here xyz ared already in embedded feature format, thus no need to embed
        xyz_input_ch = input_ch
        self.embed_time_fn, time_input_ch = get_embedder(self.t_multires, 1)
